...
PROJECTS_OVERVIEW = "\n".join(
    [
        ...
        "Калькулятор для moving-бизнеса: quote flow, pricing logic, estimate lifecycle и cost breakdown.",
        "Ценность: умение переводить сложную коммерческую логику в понятный интерфейс.",
        "Демо: https://yarsuleimenov-code.github.io/Zaberman_calc/index.html",
        "",
        "2. Warehouse Control / Loading Control",
        "MVP для складских операций: загрузка, приемка, piece-level tracking, trip reports и статусы.",
        "Ценность: работа с процессами, ролями, данными и операционными ограничениями.",
        "",
        "3. AI Portfolio Assistant",
        "Telegram-бот ИИслав для HR: knowledge base, intent routing, Docker, Google Cloud VM и отчеты.",
        "Ценность: end-to-end кейс от требований до деплоя и улучшения UX.",
        "",
        "4. Family Menu",
        "Личный продукт для планирования семейных ужинов: выбор блюд, список покупок, базовые продукты и статусы.",
        "Ценность: client-facing логика, где бытовая задача превращается в сценарий, данные и UX.",
        "Демо: https://yarsuleimenov-code.github.io/Family_menu/plan",
        "",
        "5. IITU OLAP Course",
        "Личный образовательный проект по OLAP, IBP, S&OP, логистике, бюджетированию, KPI и integrated planning.",
        "Ценность: умение структурировать сложные аналитические темы в понятный учебный продукт.",
        "Демо: https://yarsuleimenov-code.github.io/IITU_OLAP_Course/",
        "",
        "Если нужно, могу раскрыть любой проект отдельно: бизнес-задача, роль Ярослава, результат, стек или демо.",
    ]
)
LINKS_OVERVIEW = "\n".join(
    [
        ...
        "",
        "3. Демо проектов",
        "Zaberman Calculator: https://yarsuleimenov-code.github.io/Zaberman_calc/index.html",
